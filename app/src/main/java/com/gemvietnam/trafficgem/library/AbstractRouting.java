...
public abstract class AbstractRouting extends AsyncTask<Boolean, Void, List<Route>> {
     ...
     */
    @Override
    protected List<Route> doInBackground(Boolean... params) {
        List<Route> result = new ArrayList<Route>();
        try {
            result = new GoogleParser(constructURL(), params[0]).parse();
